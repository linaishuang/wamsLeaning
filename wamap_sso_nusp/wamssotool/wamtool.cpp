...
string g_ProName = "wamssotool";  // 程序名称
string g_Version = "1.0.1_1";  // 程序版本号
...
int main(int argc, char* argv[])
{
	if (argc == 2)
	{
		if (0 == strcmp(argv[1], "-v"))
		{
			char tmpver[128];
			//开发人员提供名称、版本、功能等信息
			cout << "||程序名称:WAMS次同步振荡功能设备维护工具" << endl;
			cout << "||英文名称:" << g_ProName << endl;
			cout << "||版本  号:" << g_Version << endl;
			cout << "||创建时间:2018-11-28" << endl;
			cout << "||启动参数:wamssotool -ctl new -volt 500 sso" << endl;
			cout << "||功能说明:次同步振荡设备维护" << endl;
			cout << "||开发人员:应用软件开发部" << endl;
			cout << "||最近维护时间:2018-11-28" << endl;
...
void WamExit(int iSig)
{
	...
	if (iSig != 0)
	{
		if (iSig >= -3)
		{
			g_PubLogMessShow("命令格式: wamlfotool -ctl new -volt 500 sso");
			...
			g_PubLogMessShow("  sso: 维护次同步振荡设备表");
