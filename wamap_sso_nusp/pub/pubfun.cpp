...
/*---------------------------------------------------------------------------------
    ...
    -  参    数: strSrc     [in] - 输出字符串
                 strSpliter [in] - 分割字符串
                 vDivStr    [out]- 分割之后的字符串集
    -  返 回 值: 
----------------------------------------------------------------------------------*/
bool CPubString::PS_StringDivde(const string &strSrc, const string & strSpliter, vector<string> &vDivStr)
{
    string strDiv;
