...
#ifndef _WINDOWS32
#ifdef _NUSP
#include "sysadm/proc_common.h"		//	PODB_ProcRegister
#else
...
#ifndef VEC_SSO_NUM
#define VEC_SSO_NUM 4 // SSO SSF SSP PWR 
#endif
...
public:
	...
	int  PODB_GetFesYxInfo(vector<FES_YX_TAB_CRE>& VecFesYxTab);
	int  PODB_GetFesCOMMFACInfo(vector<FES_COMM_TAB_CRE>& VecFesCOMMTab);
	int  PODB_YxYc(vector<FES_YC_TAB_CRE>& VecFesYcTab, vector<FES_YX_TAB_CRE>& VecFesYxTab, vector<FES_YX_YC>& VecFesYcYx);
