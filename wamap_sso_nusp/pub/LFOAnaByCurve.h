...
////  Macro define
#define  MODE_MAXGN       300//300           // 模式参与机组最大数
#define  MODE_MAXLN       200//200           // 模式可观线路最大数
...
//系统状态
#ifndef MENU_SSO_MENU_YES
#define MENU_SSO_MENU_YES 3 //持续振荡状态
#endif
#ifndef MENU_SSO_MENU_YESTONO
#define MENU_SSO_MENU_YESTONO 2 //振荡平息状态
#endif
#ifndef MENU_SSO_MENU_NOTOYES
#define MENU_SSO_MENU_NOTOYES 1 //起振状态
#endif
#ifndef MENU_SSO_MENU_NO
#define MENU_SSO_MENU_NO 0  //安全状态
#endif
...
public:
	...
	//  判断是否同调
	int  JudgCohcyObjByMode( float iRefAngl, float iDifValu, float iAnglVar, unsigned char iIsRad=1 );// iIsRad = 1 弧度

	//  搜索参与因子最大设备
	bool SearchMaxFact( int nPartObj, MODE_PART_OBJ *iPartObj, float &oFact, float &oPhas, int &oIndex );
	bool SearchMaxFactOpst( int nPartObj, MODE_PART_OBJ *iPartObj, float iRefAngl, float iDifValu, float &oFact, float &oPhas, int &oIndex, unsigned char iIsRad=1 );// iIsRad = 1 弧度
	
	//  振荡源机组识别
	void IdtfCausLfoGn( int &nCausGn, MODE_PART_OBJ *oCausGn, float iDifValu, unsigned char iIsRad=1 );
	void IdtfLfoGnCohcyFc( int &nCausFc, MODE_PART_OBJ *oCausFc, MODE_PART_OBJ *CausGn, float iDifValu, unsigned char iIsRad=1 );
	void IdtfLfoGnCohcyFc( int &nCausFc, MODE_PART_OBJ *oCausFc, float iRefAngl, float iOpstAngl, float iDifValu, unsigned char iIsRad=1 );
