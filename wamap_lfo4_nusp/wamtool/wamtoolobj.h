...
private:
	...
	int  InitFacInfo(vector<WT_DEV_INFO> &VecDevInfo,vector<FAC_TAB_CRE> &VecFacTab,vector<AREA_TAB_CRE> &VecAreaTab,vector<VL_TYPE_TAB_CRE> &VecVLTypeTab);
	...
	int  SetYcFlag(vector<WT_DEV_INFO> &VecDevInfo,vector<FES_YC_TAB_CRE> &VecFesYcTab,const int tableno);
