...
#ifndef AF_WAMS_SSO_NAME
#define				AF_WAMS_SSO_NAME				"wams_sso"
#endif // AF_WAMS_SSO_NAME

#ifndef AC_REALTIME_NO
#define				AC_REALTIME_NO				1
#endif // AC_REALTIME_NO

#ifndef AC_REALTIME_NAME
#define				AC_REALTIME_NAME			"realtime"
#endif // AC_REALTIME_NAME
...
#define V_A_VALUE_DF1         "w_va_mag"   // 发电机基本信息表A相电压幅值
...
// ======默认域号======================
#ifdef _NUSP
#define			GN_v_a_value		135		//发电机a相电压幅值
#define			GN_v_a_angle		137		//发电机a相电压角度
#define			GN_v_b_value		139		//发电机b相电压幅值
#define			GN_v_b_angle		141		//发电机b相电压角度
#define			GN_v_c_value		143		//发电机c相电压幅值
#define			GN_v_c_angle		145		//发电机c相电压角度
#define			GN_i_a_value		86		//发电机a相电流幅值
#define			GN_i_a_angle		151		//发电机a相电流角度
#define			GN_i_b_value		88		//发电机b相电流幅值
#define			GN_i_b_angle		153		//发电机b相电流角度
#define			GN_i_c_value		90		//发电机c相电流幅值
#define			GN_i_c_angle		155		//发电机c相电流角度
#define			GN_p				66		//发电机有功
#define			GN_q				71		//发电机无功
#define			GN_angle			161		//发电机电气功角
#define			GN_dmp_val			167		//发电机机械法功角
#define			GN_eea_val			157		//发电机内电势幅值
#define			GN_eep_val			159		//发电机内电势角度
#define			GN_f_value			36		//发电机频率
		
#define			ACLN_v_a_value		58		//交流线路端点a相电压幅值
#define			ACLN_v_a_angle		60		//交流线路端点a相电压角度
#define			ACLN_v_b_value		62		//交流线路端点b相电压幅值
#define			ACLN_v_b_angle		64		//交流线路端点b相电压角度
#define			ACLN_v_c_value		66		//交流线路端点c相电压幅值
#define			ACLN_v_c_angle		68		//交流线路端点c相电压角度
#define			ACLN_i_a_value		36		//交流线路端点a相电流幅值
#define			ACLN_i_a_angle		74		//交流线路端点a相电流角度
#define			ACLN_i_b_value		38		//交流线路端点b相电流幅值
#define			ACLN_i_b_angle		76		//交流线路端点b相电流角度
#define			ACLN_i_c_value		40		//交流线路端点c相电流幅值
#define			ACLN_i_c_angle		78		//交流线路端点c相电流角度
#define			ACLN_p				16		//交流线路端点有功
#define			ACLN_q				21		//交流线路端点无功
#define			ACLN_f_value		80		//交流线路端点频率
#define			ACLN_f_dft			82		//交流线路端点频率变化率

#define			TRWD_v_a_value		104		//变压器绕组a相电压幅值
#define			TRWD_v_a_angle		106		//变压器绕组a相电压角度
#define			TRWD_v_b_value		108		//变压器绕组b相电压幅值
#define			TRWD_v_b_angle		110		//变压器绕组b相电压角度
#define			TRWD_v_c_value		112		//变压器绕组c相电压幅值
#define			TRWD_v_c_angle		114		//变压器绕组c相电压角度
#define			TRWD_i_a_value		69		//变压器绕组a相电流幅值
#define			TRWD_i_a_angle		120		//变压器绕组a相电流角度
#define			TRWD_i_b_value		71		//变压器绕组b相电流幅值
#define			TRWD_i_b_angle		122		//变压器绕组b相电流角度
#define			TRWD_i_c_value		73		//变压器绕组c相电流幅值
#define			TRWD_i_c_angle		124		//变压器绕组c相电流角度
#define			TRWD_p				49		//变压器绕组有功
#define			TRWD_q				54		//变压器绕组无功
#define			TRWD_f_value		126		//变压器绕组频率

#define			BS_v_a_value		37		//母线a相电压幅值
#define			BS_v_a_angle		63		//母线a相电压角度
#define			BS_v_b_value		40		//母线b相电压幅值
#define			BS_v_b_angle		65		//母线b相电压角度
#define			BS_v_c_value		43		//母线c相电压幅值
#define			BS_v_c_angle		67		//母线c相电压角度
#define			BS_v_val			21		//线电压
#define			BS_f_value			31		//母线频率
#else
#define			GN_v_a_value		221		//发电机a相电压幅值
#define			GN_v_a_angle		227		//发电机a相电压角度
#define			GN_v_b_value		228		//发电机b相电压幅值
#define			GN_v_b_angle		224		//发电机b相电压角度
#define			GN_v_c_value		229		//发电机c相电压幅值
#define			GN_v_c_angle		231		//发电机c相电压角度
#define			GN_i_a_value		120		//发电机a相电流幅值
#define			GN_i_a_angle		233		//发电机a相电流角度
#define			GN_i_b_value		130		//发电机b相电流幅值
#define			GN_i_b_angle		235		//发电机b相电流角度
#define			GN_i_c_value		140		//发电机c相电流幅值
#define			GN_i_c_angle		237		//发电机c相电流角度
#define			GN_p				70		//发电机有功
#define			GN_q				80		//发电机无功
#define			GN_angle			298		//发电机电气功角
#define			GN_dmp_val			304		//发电机机械法功角
#define			GN_eea_val			294		//发电机内电势幅值
#define			GN_eep_val			296		//发电机内电势角度
#define			GN_f_value			336		//发电机频率

#define			ACLN_v_a_value		151		//交流线路端点a相电压幅值
#define			ACLN_v_a_angle		157		//交流线路端点a相电压角度
#define			ACLN_v_b_value		153		//交流线路端点b相电压幅值
#define			ACLN_v_b_angle		159		//交流线路端点b相电压角度
#define			ACLN_v_c_value		155		//交流线路端点c相电压幅值
#define			ACLN_v_c_angle		161		//交流线路端点c相电压角度
#define			ACLN_i_a_value		70		//交流线路端点a相电流幅值
#define			ACLN_i_a_angle		75		//交流线路端点a相电流角度
#define			ACLN_i_b_value		80		//交流线路端点b相电流幅值
#define			ACLN_i_b_angle		85		//交流线路端点b相电流角度
#define			ACLN_i_c_value		90		//交流线路端点c相电流幅值
#define			ACLN_i_c_angle		95		//交流线路端点c相电流角度
#define			ACLN_p				30		//交流线路端点有功
#define			ACLN_q				40		//交流线路端点无功
#define			ACLN_f_value		181		//交流线路端点频率

#define			TRWD_v_a_value		181		//变压器绕组a相电压幅值
#define			TRWD_v_a_angle		187		//变压器绕组a相电压角度
#define			TRWD_v_b_value		183		//变压器绕组b相电压幅值
#define			TRWD_v_b_angle		189		//变压器绕组b相电压角度
#define			TRWD_v_c_value		185		//变压器绕组c相电压幅值
#define			TRWD_v_c_angle		191		//变压器绕组c相电压角度
#define			TRWD_i_a_value		90		//变压器绕组a相电流幅值
#define			TRWD_i_a_angle		95		//变压器绕组a相电流角度
#define			TRWD_i_b_value		100		//变压器绕组b相电流幅值
#define			TRWD_i_b_angle		105		//变压器绕组b相电流角度
#define			TRWD_i_c_value		110		//变压器绕组c相电流幅值
#define			TRWD_i_c_angle		115		//变压器绕组c相电流角度
#define			TRWD_p				50		//变压器绕组有功
#define			TRWD_q				60		//变压器绕组无功
#define			TRWD_f_value		209		//变压器绕组频率

#define			BS_v_a_value		80		//母线a相电压幅值
#define			BS_v_a_angle		179		//母线a相电压角度
#define			BS_v_b_value		90		//母线b相电压幅值
#define			BS_v_b_angle		182		//母线b相电压角度
#define			BS_v_c_value		100		//母线c相电压幅值
#define			BS_v_c_angle		184		//母线c相电压角度
#define			BS_v_val			30		//线电压
#define			BS_f_value			50		//母线频率
#endif // _NUSP
...
#ifdef _KEDONG
#define WAM_FES_YC_DEFINE_NO_TAB 105606 // WAMS_RECV_ANALONG_NEW // wams接受遥测信息表 105606
#else
#define WAM_FES_YC_DEFINE_NO_TAB SG_WAM_FES_YC_DEFINE_RT_NO // WFES遥测定义表 104067
#endif // _KEDONG
...
#define LFO_INTFACE_NO_TAB LFO_INTFACE_NO	//LFO联络线走廊表
#define LFO_INTLINE_NO_TAB LFO_INTLINE_NO	//LFO联络线走廊与支路关系表
...
#define DSA_N1OUTAGE_NO_TAB DSA_N1OUTAGE_NO // EACCS设备开断选择 9281
#define DSA_N1RESULT_NO_TAB DSA_N1RESULT_NO // EACCS和EMS开断结果比较 9282
#ifdef _KEDONG//四方集成的WAMS平台和前置 用8006表
...
#define	SCMS_SYSTEM_INFO_NO_TAB SCMS_SYSTEM_INFO_NO	//9458	/* SCMS系统信息表 */
#define	DUTYDECI_NO_TAB DSA_DUTYDECI_NO	// 9467	/* 稳控系统当值策略表 */
#define LFO_INTFACE_NO_TAB LFO_INTFACE_NO //1924	/* LFO联络线走廊表 */
#define LFO_INTLINE_NO_TAB LFO_INTLINE_NO	//1925 LFO联络线走廊与支路关系表
// 	#define	LPO_ALL_MODE_WAMS_NO	//1926	/* LPO实时模式全表 */
// 	#define	LPO_ALLDEV_MODE_WAMS_NO	//1927	/* LPO实时设备模式全表 */
// 	#define	LPO_RT_CURVE_NO	//1928	/* LPO实时曲线表 */
